  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-4">
      ...
      <a
        ...
        target="_blank"
        className="group flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-2xl transition duration-300 hover:scale-110 hover:bg-[#1ebe5d]"
      ...
      >
        ...
        <svg
          ...
          viewBox="0 0 24 24"
          fill="currentColor"
          className="h-6 w-6 transition duration-300 group-hover:rotate-6"
        >
      ...
      <a
        ...
        target="_blank"
        className="group flex h-14 w-14 items-center justify-center rounded-full bg-blue-500 text-white shadow-2xl transition duration-300 hover:scale-110"
      >
      ...
      <a
        href="tel:0867401618"
        className="group flex h-14 w-14 items-center justify-center rounded-full bg-white shadow-2xl transition duration-300 hover:scale-110"
      >
        ...
        <svg
          ...
          viewBox="0 0 24 24"
          fill="currentColor"
          className="h-6 w-6 transition duration-300 group-hover:rotate-12"
        >
      ...
      <a
        ...
        className="group flex h-14 w-14 items-center justify-center rounded-full border border-neutral-200 bg-white shadow-2xl transition duration-300 hover:scale-110"
      >
      ...
      {showTop && (
        ...
        <button
          ...
          className="group flex h-14 w-14 items-center justify-center rounded-full border border-neutral-200 bg-white text-xl shadow-2xl transition duration-300 hover:scale-110"
        >
